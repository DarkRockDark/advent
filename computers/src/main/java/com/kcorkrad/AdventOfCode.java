...
public class AdventOfCode {
    ...
    public static void main(String[] args) {
        ...
        Integer[] opCodeArrayWorkingCopy = OPCODE_ARRAY;
        ...
        for (int i = 0; i < 100; i++) {
            for (int j = 0; j < 100; j++) {
                // reset
                opCodeArrayWorkingCopy = OPCODE_ARRAY;
                opCodeArrayWorkingCopy[i] = 12;
                opCodeArrayWorkingCopy[j] = 2;
                if (opCodeSys.processIntCode(opCodeArrayWorkingCopy)[0] == desiredOutput) {
